...
CORS_ALLOWED_ORIGINS = [
    o.rstrip('/') for o in config('CORS_ORIGINS', default='http://localhost:5173,http://127.0.0.1:5173', cast=Csv()) if o.rstrip('/')
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {'anon': '100/hour', 'order_burst': '20/hour', 'auth_burst': '5/min'},
}
